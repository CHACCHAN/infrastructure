...
| AWX側の設定(JT/Survey等) | [awx/*.yml](../../../awx/)(定義)+ [playbooks/utils/awx/configure.yml](../../../playbooks/utils/awx/configure.yml)(適用。使い方は [configure.md](configure.md)) |
...
| vm-authentik / vm-coolify / vm-ddns / vm-k3s / vm-pbs / vm-technitium / vm-wg-easy / vm-dev-setup / vm-dev-password | playbooks/vm/*.yml | [docs/vm/](../../vm/README.md) |
